...
import {getTmpldelvTreeList,getTmpldelvTree,importDelvTmpl} from "../../../../api/api"
...
export class PlanPreparedRelease extends Component {
    ...
    handleSubmit = () => {
        ...
        if(this.state.step==2){
            ...
            const pbsId = this.props.rightData && this.props.rightData.type && this.props.rightData.type == "pbs" ? this.props.rightData.id : -1;
            axios.post(importDelvTmpl(pbsId,projectId),this.state.activeIndex,true,"导入成功").then(res=>{
                this.props.importDelvTmpl(res.data.data)
            })
        }
    ...
    render() {
        ...
        return (
            <Modal className={style.main} width="850px"  centered={true}
                title="导入交付物" visible={true} onCancel={this.props.handleCancel} footer={
