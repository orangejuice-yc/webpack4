...
import { getDelvReleaseTree, updateCancleDelvpublic } from '../../../../api/api'
...
export class PlanPreparedRelease extends Component {
    ...
    getList = () => {
        axios.get(getDelvReleaseTree(this.props.projectId)).then(res => {
            this.setState({
                data: res.data.data,
    ...
    handleOk = () => {
        ...
        axios.put(updateCancleDelvpublic, activeIndex, true,null,true).then(res => {
            this.setState({
                activeIndex: [],
                rightData: []
            })
    ...
    render() {
        ...
        return (
            <Modal className={style.main} width="850px" centered={true} visible={true}
                title={intl.get("wsd.i18n.comu.meeting.cancel")}
