...
import { funcFuncs,deleteTsPlat,getTsPlatList,dowTsPlatTemp,uploadTsPlatFile} from '../../../../api/suzhou-api'
...
class DebugPlatform extends Component {
  ...
  onClickHandle = (name) => {
    ...
    //导出
    if(name == 'exportFile'){
        axios.down(dowTsPlatTemp,{}).then((res)=>{
        })
    }
      ...
      <div className={style.main}>
          ...
          <div className={style.mainHeight}>
            ...
            <div className={style.rightTopTogs}>
              {/*新增*/}
              {permission.indexOf('PROJINFO_EDIT-DEBUG-PLATFORM')!==-1 && (
              ...
              {permission.indexOf('PROJINFO_IMPORT-PLATFORM')!==-1 && (
