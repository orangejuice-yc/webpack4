...
class UploadDoc extends Component {
    ...
    handleUpload = () => {
        ...
        fileList.forEach(file => {
            ...
            axios.post(this.props.url+  `?projectId=${this.props.projectId}&sectionId=${this.props.sectionId}&projInfoId=${this.props.projInfoId}`,formData).then((res)=>{                  
    ...
    render() {
        ...
        //     action:baseURL+'/' + this.props.url+  `?projectId=${this.props.projectId}&sectionId=${this.props.sectionId}&projInfoId=${this.props.projInfoId}`,
        //     headers: {
