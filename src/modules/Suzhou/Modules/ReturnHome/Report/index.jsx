...
import {dailyReportList,getPermission} from '@/modules/Suzhou/api/suzhou-api';
...
class Sort extends Component {
    ...
    */
    ...
    getList= (currentPageNum, pageSize, callBack) =>{
        ...
        axios.get(dailyReportList(pageSize,currentPageNum),{params:{searcher:search}}).then(res=>{
                ...
                <MainContent contentWidth = {document.body.clientWidth}>
                    {this.state.projectId && (
                        <PublicTable onRef={this.onRef}
                            ...
                            pageSize={10}
                            scroll={{ x: 2400, y: this.props.height-100}}
                            />
                    )}
                </MainContent>
                {/* <RightTags
...
export default connect(state => ({
    ...
    const columns = [
        ...
        {
            title: '防疫口罩储备量',
            dataIndex: 'fykzcblNum',
            key: 'fykzcblNum',
            width:'150px'
        },
        {
            title: '防疫口罩储备天数',
            dataIndex: 'fykzcbtsNum',
            key: 'fykzcbtsNum',
            width:'150px'
        },
        {
