...
import {dailyReportDel,uploadDailyReportFile} from '@/modules/Suzhou/api/suzhou-api';
    ...
    btnClicks = (name, type) => {
        ...
        if(name == 'DeleteTopBtn'){
            ...
            if(deleteArray.length >0){
                axios.deleted(dailyReportDel, {data:deleteArray}, true).then(res => {
        ...
        return(
            <div className={style.main}>
                <div className={style.search}>
                    <Search search={this.props.search} placeholder={'项目/标段/单位'} />
                </div>
