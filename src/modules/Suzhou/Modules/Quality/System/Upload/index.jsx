...
import { dowErrorWb, uploadQuaSystemFile } from '../../../../api/suzhou-api';
...
class UploadDoc extends Component {
  ...
  handleUpload = () => {
    ...
    fileList.forEach(file => {
        ...
        axios.post(`api/szxm/zlgl/quaSystem/uploadQuaSystemFile`+`?projectId=${this.props.projectId}`,formData).then((res)=>{                  
  ...
  render() {
    ...
    //   action: baseURL + '/' + 'api/szxm/zlgl/quaSystem/uploadQuaSystemFile',
    //   headers: {
          ...
          footer={
            <div className="modalbtn">
              ...
              <Button type="primary" onClick={this.handleUpload}>
                {' '}
                {intl.get('wsd.global.btn.affirm')}{' '}
              </Button>
            </div>
          }
        >
