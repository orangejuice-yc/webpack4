    ...
    return (
      <div className={style.main}>
        <div className={style.tabMenu}>
          ...
          {props.permission.indexOf('MORTGAGE_EDIT-MORTGAGE')!==-1 && ( 
          ...
          <PublicButton
            ...
            show={props.status}
          />)}
          {props.permission.indexOf('MORTGAGE_RELEASE-MORTGAGE')!==-1 && ( 
          <PublicButton
            name={'发布审批'}
            title={'发布审批'}
            icon={'icon-fabu'}
        ...
        {this.state.isShowRelease && (
          <Release
            proc={{
              bizTypeCode: 'szxm-mortgageRefund-approve',
              title: `[${this.props.projectName}]抵押金退还发布审批`,
            }}
            reflesh={this.updateFlow.bind(this)}
            handleCancel={this.handleCancelRelease}
            // 参数
            firstList={getFlowMortgageRefundList}
