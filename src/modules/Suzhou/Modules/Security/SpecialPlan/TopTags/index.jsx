...
import {addDangerPlan,deleteDangerPlan} from '@/modules/Suzhou/api/suzhou-api';
    ...
    btnClicks = (name, type) => {
        ...
        if(name == 'DeleteTopBtn'){
            ...
            if(deleteArray.length >0){
                axios.deleted(deleteDangerPlan, {data:deleteArray}, true).then(res => {
        ...
        return(
            <div className={style.main}>
                ...
                <div className={style.tabMenu}>
                    ...
                    {props.permission.indexOf('SPECIALPLAN_EDIT-SPECIALPLAN')!==-1 && ( 
