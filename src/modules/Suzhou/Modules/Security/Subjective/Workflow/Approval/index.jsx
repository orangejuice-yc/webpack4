...
import {queryFlowDangerPlan} from '../../../../../api/suzhou-api';
import Search from '../../../../../components/Search';
...
class PlanPreparedRelease extends Component {
    ...
    initDatas =(callBack)=>{
      const {projectId,sectionId,faName,initTimeStart,initTimeEnd} = this.props;
      if(this.state.newData){
        callBack(this.state.newData)
        this.setState({newData:null})
        return
      }
      axios.get(queryFlowDangerPlan,{params:{projectId,sectionIds:sectionId,status:'INIT',faName,initTimeStart,initTimeEnd}}).then(res=>{
        if(res.data.data){
