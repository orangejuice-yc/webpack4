      ...
      <Form onSubmit={this.handleSubmit}>
        <div className={style.content}>
          <Row>
                  ...
                  rules: [
                    {
                      required: true,
                      message:
                        intl.get('wsd.i18n.message.enter') + intl.get('wsd.i18n.sys.user1.name'),
                    },
                  ],
                })(<Input />)}
              </Form.Item>
                  ...
                  rules: [
                    {
                      required: true,
                      message:
                        intl.get('wsd.i18n.message.enter') + intl.get('wsd.i18n.sys.user.actuName'),
                    },
                  ],
                })(<Input />)}
              </Form.Item>
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.actuname')} {...formItemLayout}>
                  ...
                  rules: [
                    {
                      required: true,
                      message:
                        intl.get('wsd.i18n.message.select') +
                        intl.get('wsd.i18n.sys.user1.userlevel'),
                    },
                  ],
                })(
                  <Select>
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.status')} {...formItemLayout}>
                {getFieldDecorator('staffStatus', {
                  initialValue: this.state.info.staffStatus
                    ? this.state.info.staffStatus.id.toString()
                    : '1',
                  rules: [
                    {
                      required: true,
                      message:
                        intl.get('wsd.i18n.message.select') + intl.get('wsd.i18n.sys.user1.status'),
                    },
                  ],
                })(
                  <Select>
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.cardType')} {...formItemLayout}>
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.entryDate')} {...formItemLayout}>
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.cardNum')} {...formItemLayout}>
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.leaveDate')} {...formItemLayout}>
            ...
            <Col span={12}>
              <Form.Item label={intl.get('wsd.i18n.sys.user1.sortnum')} {...formItemLayout}>
          ...
          <div className="modalbtn" style={{ display: 'flex', justifyContent: 'flex-end' }}>
            {this.props.submit == 'add' ? (
              <Button key={2} onClick={this.handleSubmit.bind(this, 'goOn')}>
                保存并继续
              </Button>
            ) : (
            ...
            <Button key={3} onClick={this.handleSubmit.bind(this, 'save')} type="primary">
              保存
            </Button>
          </div>
        </div>
