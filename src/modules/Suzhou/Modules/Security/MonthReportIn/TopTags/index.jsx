    ...
    btnClicks = (name, type) => {
        ...
        if(name == 'DeleteTopBtn'){
            ...
            if(deleteArray.length >0){
                axios.deleted(deleteMonthReport+'?type=0', {data:deleteArray}, true).then(res => {
    ...
    render(){
        ...
        return(
            <div className={style.main}>
                ...
                {props.permission.indexOf('MONTHREPORTIN_MO-REPORT-IN')!==-1 && (
                    <PublicButton name={'新增'} title={'新增'} icon={'icon-add'}
                                    afterCallBack={this.btnClicks.bind(this,'AddTopBtn')}
                                    res={'MENU_EDIT'}
                    />)}
                    {props.permission.indexOf('MONTHREPORTIN_MO-REPORT-IN-CB')!==-1 && (
                    <PublicButton name={'催报'} title={'催报'} icon={'icon-add'}
                                    ...
                                    res={'MENU_EDIT'}
                    />)}
                    {props.permission.indexOf('MONTHREPORTIN_MO-REPORT-IN-WF')!==-1 && (
                ...
                projectId={this.props.projectId} 
                proc={{  "bizTypeCode": "szxm-monthReport-approve", "title": "安全月报内部发布审批" }}
