...
class Sort extends Component {
    ...
    */
    ...
    getList= (currentPageNum, pageSize, callBack) =>{
        const {projectId,sectionId,status,searcher,companyId,year,month} = this.state;
        axios.get(queryMonthReport(pageSize,currentPageNum),{params:{type:'0',status,searcher,companyId,year,month}}).then(res=>{
    ...
    search =(val)=>{
        ...
        this.setState({
            ...
            companyId:!val.companyId?'':val.companyId,
        ...
        return(
            <ExtLayout renderWidth={({ contentWidth }) => { this.setState({ contentWidth }) }}>
                ...
                <RightTags
                        ...
                        fileEditAuth={true}
                        extInfo={{startContent: "安全管理-安全月报内部"}}
