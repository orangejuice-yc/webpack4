            ...
            <LabelFormLayout title={this.props.title}>
                <Form onSubmit={this.handleSubmit}>
                    <Row>
                        ...
                        <Col span={12}>
                            <Form.Item label={'所属年份'} {...formItemLayout}>
                        ...
                        <Col span={12}>
                            <Form.Item label={'所属月份'} {...formItemLayout}>
                ...
                <LabelFormButton>
                    ...
                    //disabled={this.props.permission.indexOf('MONTHREPORTOUT_EDIT-MONTHREPORT-OUT')==-1?true:false}
                    disabled style={{ width: "100px", marginLeft: "20px" }} type='primary'>保存</Button>
                </LabelFormButton>
            </LabelFormLayout>
        )
    }
