...
import TopTags from '../DayReportIn/TopTags/index';
    ...
    */
    ...
    getList= (currentPageNum, pageSize, callBack) =>{
        ...
        if(!projectId){
            ...
            axios.get(queryRcReport(pageSize,currentPageNum),{params:{projectId,viewType,status,xfSjStart,xfSjEnd}}).then(res=>{
    ...
    componentDidMount(){
        let menuCode = 'SECURITY-DAYREPORTOUT'
        ...
        return(
            <ExtLayout renderWidth={({ contentWidth }) => { this.setState({ contentWidth }) }}>
                ...
                <RightTags
                        ...
                        isShow={this.state.permission.indexOf('DAYREPORTOUT_FILE-DAYREPORT-OUT')==-1?false:true} //文件权限
                        fileRelease={this.state.permission.indexOf('DAYREPORTOUT_FILE-ISSUE-OUTDAYREP')==-1?false:true}//文件发布权限
                        permission={this.state.permission}
                    />
            </ExtLayout>
        )
