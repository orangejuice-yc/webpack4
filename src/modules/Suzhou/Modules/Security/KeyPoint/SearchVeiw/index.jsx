          ...
          this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                if (values.searchTime && Array.isArray(values.searchTime)) {
                    ...
                    values.acceptTimeFrom = values.searchTime[0];
                    values.acceptTimeTo = values.searchTime[1];
                  } else {
                    values.acceptTimeFrom = '';
                    values.acceptTimeTo = '';
                  }
                this.setState({
                    clicked: false,
            ...
            <Form onSubmit={this.handleSubmit} style={{ width: 380 }} className={style.formstyle}>
                <div className={style.content}>
                    <Row >
                        ...
                        <Col span={24}>
                            <Form.Item label="验收状态" {...formItemLayout}>
                        ...
                        <Col span={24}>
                            <Form.Item label="附件状态" {...formItemLayout} >
                                {getFieldDecorator('accessoryStatus', {
                                })(
                                    <Select allowClear 
                                    style={{width:'100%', marginRight: 10}}
                                                // defaultValue="0" 
