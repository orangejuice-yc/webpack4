...
import {updateDangerProject,getDangerProjectInfo} from '../../../../api/suzhou-api';
...
class SortInfo extends Component {
    ...
    getData = (id) => {
        // 请求获取info数据
        axios.get(getDangerProjectInfo(id)).then(res => {
            this.setState({
                info: res.data.data,
            });
        });
        ...
        return(
            <LabelFormLayout title={this.props.title}>
                ...
                <LabelFormButton>
                    ...
                    <Button onClick={this.handleSubmit} disabled={((this.props.rightData.statusVo &&this.props.rightData.statusVo.code == 'INIT') || (this.props.taskFlag))?(this.props.permission.indexOf('DANGPROACCEPTANCE_EDIT-DANGPROACCEPT')==-1?true:false):true}  style={{ width: "100px", marginLeft: "20px" }} type='primary'>保存</Button>
                </LabelFormButton>
            </LabelFormLayout>
        )
    }
