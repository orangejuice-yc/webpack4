...
export class TopTags extends Component {
    ...
    render() {
        const { openPro, openSection, section, data1, search, record, updateSuccess,permission } = this.props
        ...
        return (
            <div className={style.main}>
                ...
                <div className={style.tabMenu}>
                    ...
                    {permission.indexOf('INSPECTION_EDIT-DEVICE-INSPECT')!==-1 && ( 
                    <PublicButton 
                        name={'新增'} 
                        title={'新增'} 
                        icon={'icon-add'}
                        ...
                        res={'MENU_EDIT'}
                    />)}
                    {permission.indexOf('INSPECTION_APPROVAL-INSPECTION')!==-1 && (
                    <PublicButton name={'发布审批'} 
                        title={'发布审批'} 
                        icon={'icon-fabu'}
                ...
                {this.state.isShowRelease && 
                    ...
                    projectId={this.props.data1} 
                    proc={{  "bizTypeCode": "szxm-deviceCheck-approve", "title": this.state.projectName+"设备报验发布审批" }}
