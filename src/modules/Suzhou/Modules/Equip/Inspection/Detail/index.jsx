...
const columns = [
    ...
    },
    {
        ...
        key: 'deviceBirthday',
        render:(text,record)=>{
            return <span>{!text?null:dataUtil.Dates().formatTimeString(text).substr(0,10)}</span>
        }
    },
    {
        title: '设备有效期',
        ...
        return (
            <div className={style.main}>
                <div className={style.mainHeight}>
                    ...
                    {permission.indexOf('INSPECTION_EDIT-DEVICE-DETAILS')!==-1 && (
                        <PublicButton 
                        ...
                        <PublicButton 
                            ...
                            res={'MENU_EDIT'}
                        />)}
                        {permission.indexOf('INSPECTION_IMPORT-DEVICE-DETAIL')!==-1 && (
                        <PublicButton 
                            edit={((this.props.rightData.statusVo &&this.props.rightData.statusVo.code == 'INIT') || (this.props.rightData.statusVo && this.props.rightData.statusVo.code == 'REJECT' && this.props.taskFlag))?true:false}
                            name={'导入'} 
                            title={'导入'} 
