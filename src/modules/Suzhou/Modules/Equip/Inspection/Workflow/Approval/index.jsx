...
import {queryFlowDeviceCheckList} from '../../../../../api/suzhou-api';
import Search from '../../../../../components/Search';
class PlanPreparedRelease extends Component {
    ...
    initDatas =()=>{
      ...
      axios.get(queryFlowDeviceCheckList+`?projectId=${projectId}&sectionIds=${sectionId}&title=${title}&status=INIT`).then(res=>{
        this.setState({
            data:res.data.data,
