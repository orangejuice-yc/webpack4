...
import {dowErrorWb} from '../../../../api/suzhou-api';
...
class UploadDoc extends Component {
    ...
    handleUpload = () => {
        ...
        fileList.forEach(file => {
            ...
            axios.post(`api/szxm/sbgl/check/uploadDeviceDetailFile` + `?deviceCheckId=${this.props.deviceCheckId}&projectId=${this.props.projectId}&sectionId=${this.props.sectionId}`,formData).then((res)=>{                  
    ...
    render() {
        ...
        //     action:baseURL+'/' +`api/szxm/sbgl/check/uploadDeviceDetailFile`+  `?deviceCheckId=${this.props.deviceCheckId}&projectId=${this.props.projectId}&sectionId=${this.props.sectionId}`,
        //     headers: {
