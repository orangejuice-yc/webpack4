    ...
    return (
      <div className={style.main}>
        ...
        <div className={style.tabMenu}>
          ...
          {permission.indexOf('STOPREVORKAPPLY1_EDIT-STOPRETURNAPPLY')!==-1 && (
          <PublicButton
            name={'新增'}
            title={'新增'}
            icon={'icon-add'}
          ...
          <PublicButton
            ...
            res={'MENU_EDIT'}
          />)}
          {permission.indexOf('STOPREVORKAPPLY1_APPROVAL-RETURN-WORK')!==-1 && (
          <PublicButton
            name={'发布审批'}
            title={'发布审批'}
            show={this.props.rightData && this.props.rightData.statusVo.code == 'INIT' && (this.props.rightData.creator == this.props.loginUser.id) ?true:false}
            icon={'icon-fabu'}
          ...
          {this.state.isShowRelease && (
            <Release
              proc={{
                bizTypeCode: 'SCH-2019NCOV-STAOP',
                title: `[疫情专项]${this.props.menuInfo.menuName}发布审批`,
              }}
