...
import { Form, Modal, Row, Col, Input, TreeSelect, DatePicker, Select } from 'antd'
...
class AddOrder1 extends Component {
  constructor(props) {
    super(props)
    this.state = {
      treeData: [],
  ...
  handleOk = () => {
    this.props.form.validateFields((err, values) => {
      if (err) {
        ...
        const {sectionId, applyNum, contract, content, remark, type} = values
        const {projectId} = this.props
        axios.post(addStopRework(), {projectId, sectionId, applyNum, contract, content, remark, applyType: '1', type}).then(res => {
...
const AddOrder = Form.create({name: 'AddOrder'})(AddOrder1)
