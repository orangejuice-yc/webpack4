...
export class Search extends Component {
    ...
    click() {
        if(this.props.search){
            ...
            this.props.search(data,'searcher');
        }
    }
    //气泡显影
          ...
          this.props.form.validateFieldsAndScroll((err, values) => {
            ...
            if (!err) {
                if (values.searchTime && Array.isArray(values.searchTime)) {
                    obj = {
                        dispatchStartTime:moment(values.searchTime[0]).format('YYYY-MM-DD'),
                        dispatchEndTime:moment(values.searchTime[1]).format('YYYY-MM-DD')
                    }
                } else {
                    obj={
                        dispatchStartTime:'',
        ...
        const content = (
            <Form onSubmit={this.handleSubmit} style={{ width: 380 }} className={style.formstyle}>
                <div className={style.content}>
                    <Row >
                        <Col span={24}>
                            <Form.Item label="派工时间"  {...formItemLayout}>
        ...
        return (
            <div className={style.main}>
                <span>
                    ...
                    <input type="text" placeholder="编号/名称" ref={input => this.input = input} />
                </span>
