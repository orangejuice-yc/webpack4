...
import {storageList,getPermission} from '@/modules/Suzhou/api/suzhou-api';
...
class Sort extends Component {
    ...
    */
    ...
    getList= (currentPageNum, pageSize, callBack) =>{
        ...
        axios.get(storageList(pageSize,currentPageNum),{params:{projectId,sectionIds:sectionId,storageDate:instockDate,searcher:search}}).then(res=>{
