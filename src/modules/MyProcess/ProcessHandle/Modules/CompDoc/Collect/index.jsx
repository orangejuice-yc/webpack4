...
class UploadDoc extends Component {
    ...
    handleSubmit = () => {
        if (this.state.rightData) {
            axios.post(docFavoriteDoc(this.props.record.id, this.state.rightData.id), {}, true, '收藏成功').then(res => {
                ;
                this.props.update();
                this.handleCancel();
            })
    ...
    addFolder = () => {
        ...
        axios.post(docFavoriteAdd, data, true, '新增成功').then(res => {
            ;
    ...
    inputBlur = (record, e) => {
        ...
        axios.put(docFavoriteUpdate, data, true, '修改成功').then(res => {
                ...
                <Modal
                    ...
                    footer={
                        <div className='modalbtn'>
                            <Button key="bwee" type="primary" block className={style.btn} onClick={this.addFolder} >新建文件夹</Button>
