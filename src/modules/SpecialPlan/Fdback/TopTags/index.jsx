    ...
    return (
      <div className={style.main}>
        ...
        <div className={style.tabMenu}>
          <SelectPlanBtn openPlan={this.props.openPlan} type = {"2"} typeCode ='specialFeedback'/>
        ...
        {this.state.showApprovalVisible &&
          <Approval proc={{ "vars": {}, "procDefKey": "", "bizTypeCode": "plan-specialfeedback-approve", "title": this.state.projectName + "专项进展反馈审批" }}
            visible={true}
