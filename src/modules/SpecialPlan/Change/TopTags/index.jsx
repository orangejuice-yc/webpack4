    ...
    return (
      <div className={style.main}>
        ...
        <div className={style.tabMenu}>
          {/*选择项目计划 */}
          <SelectPlanBtn openPlan={openPlan} type={"2"} typeCode = 'specialChange'/>
        ...
        <Approval
          visible = {true}
          width = {"1200px"}
          proc={{ "vars": {}, "procDefKey": "", "bizTypeCode": "plan-specialchange-approve", "title": this.state.projectName+ "专项计划变更审批"}}
          projectId={this.props.selectProjectId}
          projectIds = {projectIds}
