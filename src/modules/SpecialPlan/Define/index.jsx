...
import { defineTree, defineDel, isHasTaskByDefineId } from '../../../api/api'
...
export class PlanDefine extends Component {
    ...
    initDatas = (callBack) => {
        dataUtil.CacheOpenProjectByType('specialDefine').getLastOpenProject((data) => {
    ...
    getPlanTreeList = (callBack) => {
        if (this.state.projectId) {
            axios.get(defineTree_(this.state.projectId, "2")).then(res => {
