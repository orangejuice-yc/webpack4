    ...
    render() {
        ...
        return (
            <div className={style.main}>
                <Modal className={style.formMain} width="850px"  centered={true} title={this.props.title + '基线'}
                mask={false}
                maskClosable={false}
                    visible={this.props.modalVisible} onCancel={this.props.handleCancel} footer={
                        <div className="modalbtn">
                            {this.props.type == 'add' ?
                                ...
                                : <SubmitButton key="abolish" onClick={this.props.handleCancel} content="取消" />
                            }

                        <SubmitButton key="save" type="primary" onClick={this.handleSubmit.bind(this, 'save')} content="保存" />
                        </div>
                    }>
                                    ...
                                    {/* 基线类型 */}
                                        <div className={style.list}>
                                            {getFieldDecorator('baselineType', {
                                                ...
                                                rules: [{
                                                    required: true,
                                                    message: intl.get('wsd.i18n.message.select') + intl.get('wsd.i18n.plan.baseline.baselinetype'),
                                                }],
                                            })(
                                                <Select>
                                    ...
                                    {/* 备注 */}
                                        <div className={style.list}>
                                            {getFieldDecorator('remark', {
                                                ...
                                                <TextArea maxLength={666} rows={4} style={{ width: '100%' }} />
                                            )}
                                        </div>
                                    </Form.Item>
                                </Col>
