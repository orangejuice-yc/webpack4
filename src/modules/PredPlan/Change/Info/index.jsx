      ...
      this.props.form.validateFieldsAndScroll((err, values) => {
        if (!err) {
          ...
          const data = {
            ...
            newPlanStartTime: dataUtil.Dates().formatTimeString(values['newPlanStartTime'] ? values['newPlanStartTime'] : values['newPlanEndTime']),
            newPlanEndTime: dataUtil.Dates().formatTimeString(values['newPlanEndTime'] ? values['newPlanEndTime'] : values['newPlanStartTime']),
                ...
                <Form onSubmit={this.handleSubmit}>
                  ...
                  <Form.Item label="计划类型" {...formItemLayout}>
                    {getFieldDecorator('newPlanType', {
                      initialValue: info.newPlanType ? info.newPlanType.id : '',
                      rules: [],
                    })(
                      <Select disabled={delChange} onFocus={() => {
                      ...
                      }}>
                        {
                          this.state.planTypeList ? this.state.planTypeList.map((v, i) => {
                            ...
                            <Option key={info.newPlanType.id} value={info.newPlanType.id}> {info.newPlanType.name} </Option>
                        }
                      </Select>
                    )}
                  </Form.Item>
                  ...
                  {/* {(rightData.taskType == 1 || rightData.taskType == 4) && <div>
                    <Form.Item label="作业类型" {...formItemLayout}>
                      {getFieldDecorator('newTaskType', {
                        initialValue: info.newTaskType ? info.newTaskType : '',
                        rules: [],
                      })(
                        <Select disabled={delChange}>
                          {
                    ...
                    <Form.Item label="工期类型" {...formItemLayout}>
                      {getFieldDecorator('newTaskDrtnType', {
                        initialValue: info.newTaskDrtnType ? info.newTaskDrtnType.id : '',
                        rules: [],
                      })(
                        <Select disabled={delChange} onFocus={() => {
                        ...
                        }}>
                          {
                            this.state.planTaskDrtnTypeList ? this.state.planTaskDrtnTypeList.map((v, i) => {
                              return <Option value={v.value} key={i}>{v.title}</Option>
                            }) : info.newTaskDrtnType &&
                              <Option key={info.newTaskDrtnType.id} value={info.newTaskDrtnType.id}> {info.newTaskDrtnType.name} </Option>
                          }
                        </Select>
                      )}
                    </Form.Item>
                    ...
                    <Col span={12}>
                      <Form.Item label={intl.get('wsd.i18n.base.planTemAddWBS.iswbsfb')} {...formItemLayout2}>
                        {getFieldDecorator('newWbsFeedBack', {
                          initialValue: info.newWbsFeedBack == 1 ? true : false,
                          valuePropName: 'checked',
                        })(
                          <Switch disabled={delChange} checkedChildren="开" unCheckedChildren="关"/>
                        )}
                      </Form.Item>
                    </Col>
                    {/* <Col span={12}>
                      <Form.Item
                        ...
                        {getFieldDecorator('newControlAccount', {
                          initialValue: info.newControlAccount == 1 ? true : false,
                          valuePropName: 'checked',
                        })(
                          <Switch disabled={delChange} checkedChildren="开" unCheckedChildren="关"/>
                        )}
              ...
              <Col span={12}>
                ...
                <Form>
                  ...
                  {(rightData.taskType == 0 || rightData.taskType == 1 || rightData.taskType == 4) && <div>
                    ...
                    {/* <Form.Item label="计划工时" {...formItemLayout}>
                      {getFieldDecorator('oldPlanQty', {
                        initialValue: info.oldPlanQty,
                        rules: [],
                      })(
                        <InputNumber style={{width: '100%'}} max={999999999999} min={0} precision={projSet.precision}
                                     formatter={value => `${value}` + projSet.timeUnit}
                  ...
                  <Form.Item label="计划类型" {...formItemLayout}>
                    {getFieldDecorator('oldPlanType', {
                      initialValue: info.oldPlanType ? info.oldPlanType.name : '',
                      rules: [],
                    })(
                      <Input disabled={true}/>
                    )}
                  ...
                  {/* {(rightData.taskType == 1 || rightData.taskType == 4) && <div>
                    ...
                    <Form.Item label="工期类型" {...formItemLayout}>
                      {getFieldDecorator('oldTaskDrtnType', {
                        initialValue: info.oldTaskDrtnType ? info.oldTaskDrtnType.name : '',
                        rules: [],
                      })(
                        <Input disabled={true}/>
                      )}
                  ...
                  {rightData.nodeType == 'wbs' && <Row>
                    <Col span={12}>
                      <Form.Item label={intl.get('wsd.i18n.base.planTemAddWBS.iswbsfb')} {...formItemLayout2}>
                        {getFieldDecorator('oldWbsFeedBack', {
                          initialValue: info.oldWbsFeedBack == 1 ? true : false,
                          valuePropName: 'checked',
                        })(
                    ...
                    {/* <Col span={12}>
                      <Form.Item
                        label={intl.get('wsd.i18n.base.planTemAddWBS.isctrl')} {...formItemLayout2}>
                        {getFieldDecorator('oldControlAccount', {
                          initialValue: info.oldControlAccount == 1 ? true : false,
                          valuePropName: 'checked',
                        })(
                          <Switch checkedChildren="开" unCheckedChildren="关" disabled={true}/>
                        )}
