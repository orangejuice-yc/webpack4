...
import { Table,Modal, Input, Form,  Popconfirm, Select, notification } from 'antd'
        ...
        return (
            <div className={style.main}>
                ...
                <div className={style.rightTopTogs}>
                    {/*分配*/}
                    <PublicButton title={"新增变更"} edit={this.props.editAuth} icon={"icon-fenpei"} afterCallBack={this.onClickHandle}/>
                    {/* <DistributionBtn onClickHandle={this.onClickHandle} edit={this.props.editAuth} /> */}
                    {/*删除*/}
                    <PublicButton title={"申请删除"} edit={this.props.editAuth && this.state.delAuth} useModel={true}
                                  content = {"您确定对该记录申请删除变更？"} verifyCallBack = {this.deleteVerify} afterCallBack={this.deletePlanTaskPred} icon={"icon-delete"} />
                    {/**取消变更 */}
                    <PublicButton title={"取消变更"} edit={this.props.editAuth && this.state.cancelAuth } useModel={true}
