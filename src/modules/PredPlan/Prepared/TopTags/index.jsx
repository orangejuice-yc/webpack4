    ...
    return (
      <div className={style.main}>
        ...
        <div className={style.tabMenu}>
          {/*选择项目计划*/}
          <SelectPlanBtn openPlan={openPlan} type = {"1"} typeCode ='predTask'/>
        ...
        {this.state.releaseApprovalModalVisible &&
          <Approval proc={{ "vars": {},"remark": "", "procDefKey": "", "bizTypeCode": "plan-predtask-release", "title": this.state.projectName + "前期项目计划发布审批" }}
            visible={true}
            projectId={this.props.selectProjectId }
        ...
        {this.state.templateVisible && <AddTemplate handleCancel={this.handleCancelTemplate} addData={this.props.rightData} />}
        {
          this.state.showImportExcel && (
            <ImportExcel title={"导入Excel"}
                         ...
                         sheets={[{ index: 0, rowStart: 5, colEnd: 10 }]}
                         params={params}
                         ...
                         defaultColumns:["planLevel","code","planType"]}}>
            </ImportExcel>
          )
        }
      </div>
