    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, val) => {
            if (!err) {
              ...
              localStorage.setItem("planBaseLineParam2",JSON.stringify({firstBaseLine,secondBaseLine, defineId,projectId}))
                                ...
                                <Col span={12}>
                                    <Form.Item label={"执行计划"} {...formItemLayout}>
                                        ...
                                        {getFieldDecorator('firstBaseLine', {
                                            ...
                                            rules: [{
                                                required: true,
                                                message: intl.get('wsd.i18n.message.enter') + "执行计划",
                                            }],
                                        })(
                                            <Select >
                                                {this.props.planBaseLineCompareList.length ? this.props.planBaseLineCompareList.map(item => {
                                                    return (
                                ...
                                <Col span={12}>
                                    <Form.Item label={intl.get('wsd.i18n.plan.baseline.comparebaseline')} {...formItemLayout}>
                                        ...
                                        {getFieldDecorator('secondBaseLine', {
                                            ...
                                            rules: [{
                                                required: true,
                                                message: intl.get('wsd.i18n.message.enter') + " 对比基线",
                                            }],
                                        })(
                                            <Select >
                                                {this.props.planBaseLineCompareList.length ? this.props.planBaseLineCompareList.map(item => {
