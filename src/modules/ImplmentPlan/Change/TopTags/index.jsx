    ...
    return (
      <div className={style.main}>
        ...
        <div className={style.tabMenu}>
          {/*选择项目计划 */}
          <SelectPlanBtn openPlan={openPlan} type={"3"} typeCode = 'implmentChange'/>
        ...
        <Approval
          visible = {true}
          width = {"1200px"}
          proc={{ "vars": {}, "procDefKey": "", "bizTypeCode": "plan-implmentchange-approve", "title": this.state.projectName+ "实施计划变更审批"}}
          projectId={this.props.selectProjectId}
          projectIds = {projectIds}
