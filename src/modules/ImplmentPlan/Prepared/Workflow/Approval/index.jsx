...
import {releasePlanTaskTree} from "../../../../../api/api";
import {releasePlanTaskTree_} from "../../../../../api/suzhou-api"
import {
  impPlan_
} from "../../../../../api/suzhou-api"
class PlanTaskReleaseApproval extends Component {
    ...
    initDatas =()=>{
      ...
      /*axios.get(releasePlanTaskTree(this.props.projectId,"3" || 0)).then(res=>{
        this.setState({
          data:res.data.data,
    ...
    render() {
        ...
        const rowSelection = {
          ...
          getCheckboxProps: record => ({
            disabled: !(record.status && ( record.status.id == 'CONFIRM' || record.status.id == 'EDIT'))
          })
        };
