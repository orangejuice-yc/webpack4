...
export class PlanDefineAdd extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      inputValue: 1,
      orgTree: [],
      planTypeList: [{value: "3", title: "实施计划"}],
      orgUserList: [],
      sectionTree:[],
    ...
    if(this.state.runnDone){
      ...
      this.props.form.validateFieldsAndScroll((err, fieldsValue) => {
        if (!err) {
          ...
          let url = dataUtil.spliceUrlParams(defineAdd_,{"startContent":this.props.projectName});
  ...
  sectionChange = (e,y) => {
      this.props.form.setFieldsValue({planName : y[0] + "项目实施计划"})
  }
