...
import { docProjectRelease,docReleaseReationsList,docProjectCalcRelease } from '../../../../../api/api'
...
class Publicd extends Component {
    ...
    getDataList = (callBack) => {
        if (this.props.type == 'approval'){
          axios.get(docReleaseReationsList(this.props.bizId,this.props.bizType,'EDIT')).then(res=>{
            if(res.data.data){
        ...
        } else if(this.props.type == 'calcApproval'){
          axios.get(docReleaseReationsList(this.props.bizId,this.props.bizType,'RELEASE')).then(res=>{
            if(res.data.data){
              callBack(res.data.data)
            }else{
              callBack([])
    ...
    submitClick = () => {
      ...
      if (this.props.type == 'approval'){
            ...
            let { startContent } = this.props.extInfo || {};
            let url = dataUtil.spliceUrlParams(docProjectCalcRelease, { startContent });
            axios.put(url, selectedRowKeys, true, '取消发布成功', true).then(res => {
                this.props.refresh();
                this.props.handleCancel();
            })
        }
