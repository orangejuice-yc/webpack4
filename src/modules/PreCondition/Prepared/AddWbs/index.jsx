...
class PlanPreparedAddWbs extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      planTypeList: {value: "4", title: "前置条件"},
  ...
  handleSubmit = (bol) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        const { rightData, title } = this.props
        const data = {
          ...values,
        ...
        this.props.addPlanWbs(data, title == '新增同级WBS' ? false : true)
        if (!bol) {
        ...
        <Modal className={style.formMain} width="850px" centered={true} mask={false} maskClosable={false}
          ...
          <Form onSubmit={this.handleSubmit}>
            <div className={style.content}>
              ...
              {/* <Row>
                <Col span={11}>
                  <Form.Item label={intl.get('wsd.i18n.base.planTemAddWBS.estwt')} {...formItemLayout}>
