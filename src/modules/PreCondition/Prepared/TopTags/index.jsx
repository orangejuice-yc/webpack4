  ...
  showToolModal = (name, e) => {
    ...
    if (name == "4") {
      ...
      setTimeout(function () {
        ...
        // window.open("/api/plan/task/export/plan?defineIds="+projectIds)
      }, 1000)
    }
    if (name == "6") {
      if (!(this.props.rightData.nodeType == "define")) {
    ...
    return (
      <div className={style.main}>
        ...
        <div className={style.tabMenu}>
           {/*打开项目*/}
           <SelectProjectBtn openProject = {this.props.openProject} preCondtion={true} typeCode = 'predConditionTask'/>
          ...
          {/*增加任务*/}
          <PublicButton title={"任务"} afterCallBack={this.showAddTaskFormModal} icon={"icon-renwu-"} edit={ this.props.menusEdit["task"]["1"]}/>
          {/*删除*/}
          ...
          {<PublicMenuButton title={"工具"} afterCallBack={this.showToolModal} icon={"icon-gongju"}
            menus={[
             ...
             // { key: "2", label: "横道设置", icon: "icon-iconziyuan4", edit: true },
              ...
              //{ key: "8", label: "导入P6文件", icon: "icon-iconziyuan2", edit: true }
            ]}
          />}
        ...
        {/* {this.state.releaseApprovalModalVisible &&
          <Approval proc={{ "vars": {}, "procDefKey": "model_20190513_2687523", "bizTypeCode": "plan-task-release", "title": this.state.projectName + "项目计划发布审批" }}
            visible={true}
            projectId={this.props.selectProjectId}
