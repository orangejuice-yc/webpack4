...
class Home extends React.Component {
  ...
  handelGetMenuData = data => {
    this.setState({
      menuData: data ? data : [],
    });
  };
  handleClickTargetMenuItem = (data, index) => {
    this.setState({
      menuItem: data,
      menuItemIndex: index,
    });
    ...
    return (
      <div className={style.main}>
        <Header
          ...
          // 新布局需要参数
          layoutType="LAYOUT2"
          handelGetMenuData={this.handelGetMenuData}
        ...
        <div className={style.layoutContent}>
          <MenuComponent
            ...
            handleClickTargetMenuItem={this.handleClickTargetMenuItem}
          />
          <Tabs
          ...
          >
            {this.state.panes.map(pane => (
              <TabPane
                ...
                times={pane.times}
                style={{ height: 'calc(100vh - 98px)', marginTop: 8 }}
              >
                {pane.content}
              </TabPane>
            ))}
